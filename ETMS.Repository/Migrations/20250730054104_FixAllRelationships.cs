        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MagicLinkToken = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AuditLogs_Users_UpdatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Project_Users_UpdatedByUserId",
                        column: x => x.UpdatedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Boards_Users_UpdatedByUserId",
                        column: x => x.UpdatedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsVirusScanCompleted = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Attachment_OneParent", "([ProjectId] IS NOT NULL AND [TaskId] IS NULL) OR ([ProjectId] IS NULL AND [TaskId] IS NOT NULL)");
                    table.ForeignKey(
                        name: "FK_Attachments_Project_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Project",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Attachments_Users_UpdatedByUserId",
                        column: x => x.UpdatedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Comment_OneParent", "([ProjectId] IS NOT NULL AND [TaskId] IS NULL) OR ([ProjectId] IS NULL AND [TaskId] IS NOT NULL)");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 7, 30, 5, 41, 3, 641, DateTimeKind.Utc).AddTicks(6482), null, "This is Admin Role. It will have all the permissions.", false, "Admin", null, null },
                    { 2, new DateTime(2025, 7, 30, 5, 41, 3, 641, DateTimeKind.Utc).AddTicks(6617), null, "This is Program Manger Role.", false, "Program Manager", null, null },
                    { 3, new DateTime(2025, 7, 30, 5, 41, 3, 641, DateTimeKind.Utc).AddTicks(6644), null, "This is Project Manger Role.", false, "Project Manager", null, null },
                    { 4, new DateTime(2025, 7, 30, 5, 41, 3, 641, DateTimeKind.Utc).AddTicks(6664), null, "This is Team Lead Role.", false, "Team Lead", null, null },
                    { 5, new DateTime(2025, 7, 30, 5, 41, 3, 641, DateTimeKind.Utc).AddTicks(6682), null, "This is Senior Developer Role.", false, "Senior Developer", null, null },
                    { 6, new DateTime(2025, 7, 30, 5, 41, 3, 641, DateTimeKind.Utc).AddTicks(6702), null, "This is Junior Developer Role.", false, "Junior Developer", null, null },
                    { 7, new DateTime(2025, 7, 30, 5, 41, 3, 641, DateTimeKind.Utc).AddTicks(6720), null, "This is default User Role.", false, "User", null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "", new DateTime(2025, 7, 30, 5, 41, 3, 641, DateTimeKind.Utc).AddTicks(6253), null, null, false, "Pending", null, null },
                    { 2, "", new DateTime(2025, 7, 30, 5, 41, 3, 641, DateTimeKind.Utc).AddTicks(6256), null, null, false, "Completed", null, null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_UpdatedByUserId",
                table: "AuditLogs",
                column: "UpdatedByUserId");
